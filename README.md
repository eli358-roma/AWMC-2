...
Area Amministrativa
  ...
  •	Gestione di:
    o	Create: Aggiunta nuove parole con validazione duplicati
    o	Read: Visualizzazione lista parole con ricerca
    o	Update: Modifica parole esistenti
