...
<head>
    ...
    <title>Chinese Dictionary - Area Amministrativa</title>
...
<body>
    <div class="container">
        <div class="header-flex">    
            ...
            <small class="text-muted">Area <?= htmlspecialchars($_SESSION['username'] ?? 'Amministratore') ?> - Gestione Dizionario </small>
            <div>
                <a href="/admin/create" class="btn btn-danger">Aggiungi Nuova Parola</a>
        ...
        <form method="get" class="search-form">
            ...
            <?php if (!empty($search)): ?>
                <a href="/admin" class="btn btn-outline-dark btn-sm">Reset</a>
            <?php endif; ?>
        </form>
        <br>
        ...
        <div class="table-responsive">
            <?php if (empty($words)): ?>
                <div class="alert alert-info">
                    ...
                    <?php else: ?>
                        📝 Nessuna parola nel database. <a href="/admin/create" class="alert-link">Aggiungi la prima!</a>
                    <?php endif; ?>
                </div>
            <?php else: ?>
                        ...
                        <?php foreach ($words as $word): ?>
                            <tr>
                                ...
                                <td data-label="Azioni">
                                    <a href="/admin/edit/<?= $word['id'] ?>" class="btn btn-outline-primary btn-sm">Modifica</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
